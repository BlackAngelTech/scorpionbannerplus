/**
 * ============================================================
 * SCORPION X – PAIR.JS (Simplified Working Version)
 * ============================================================
 */
...
async function sendSessionMessage(sock, userJid, sessionBuffer) {
    try {
        // Send session file
                ...
                if (connection === 'open') {
                    ...
                    try {
                        ...
                        if (fs.existsSync(credsFile)) {
                            ...
                            await sendSessionMessage(sock, userJid, sessionBuffer);
